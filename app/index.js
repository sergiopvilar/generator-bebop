...
var BebopGenerator = module.exports = function BebopGenerator(args, options, config) {
...
BebopGenerator.prototype.app = function app() {
  ...
  this.copy('src/assets/js/vendor/jquery-1.10.2.min.js', 'src/assets/js/vendor/jquery-1.10.2.min.js');
  this.copy('src/assets/js/vendor/modernizr-2.7.0.min.js', 'src/assets/js/vendor/modernizr-2.7.0.min.js');
